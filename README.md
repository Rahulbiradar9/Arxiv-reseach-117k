...
![Train vs Validation Loss](screenshots/train_vs_val_loss.png)
...
*Full text report is available at `screenshots/classification_report.txt`.*
...
![Precision‑Recall Curves](screenshots/precision_recall_curves.png)
